...
exports.verifyToken = exports.roleId = exports.userid = void 0;
const constants = __importStar(require("../controller/constants"));
const message = __importStar(require("../controller/messges"));
...
function verifyToken(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let adminOrUser = reqPath.split("/")[1];
        if (adminOrUser == "admin" || adminOrUser == "user") {
            ...
            try {
                ...
                exports.userid = decoded.userid;
                exports.roleId = decoded.roleid;
